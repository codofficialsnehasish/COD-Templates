...
Route::get("/customer",[Admin::class,"customer"])->middleware("admin");
...
Route::get("/bill",[Admin::class,"bill"])->middleware("admin");
...
Route::get("/edit_bill/{id}",[Admin::class,"edit_bill"])->middleware("admin");
Route::post("/editbill",[Admin::class,"edited_bill"]);
Route::get("/editcustomer/{id}",[Admin::class,"edit_customer"])->middleware("admin");
