                                            ...
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/editbill')}}" method="post">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="{{$bill->current_unit}}" name="currb" id="currb" placeholder="Enter current bill" required>
                                                    </div>
                                                    <div class="mb-3 mt-3">
                                                        <label class="form-label" for="prevb">Previous Unit</label>
                                                        <input type="text" class="form-control" value="{{$bill->previous_unit}}" name="prevb" id="prevb" placeholder="Enter previous bill" required>
                                                    </div>
                                                    <div class="mb-3 mt-3">
                                                        <label class="form-label" for="preb">Pre Bill</label>
                                                        <input type="text" class="form-control" value="{{$bill->pre_bill}}" name="preb" id="preb" placeholder="Enter previous bill" required>
                                                    </div>
                                                    <div class="mb-3 mt-3">
