                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Send Bill</h6>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-12">
                                        <div class="card">
                                            <div class="card-header bg-primary text-light">Bill Massage</div>
                                            <div class="card-body">
                                                <form class="custom-validation" action="{{url('/send')}}" method="post">
                                                    @csrf
                                                    <div class="md-3">
                                                    ...
                                                    <div class="mb-3 mt-3">
                                                        <label class="form-label" for="elm1">Massage</label>
                                                        <div id="area">
                                                            <textarea readonly id="elm" name="massage" style="width: 100%;height: 150px;padding: 12px 20px;box-sizing: border-box;border: 2px solid #ccc;border-radius: 4px;background-color: #f8f8f8;font-size: 16px;">
                                                    ...
                                                    <div class="mb-0">
                                                        <div>
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light me-1">Send</button>
